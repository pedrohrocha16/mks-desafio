...
function Card({ product }: Props) {
   ...
   return (
      <div className='flex flex-col h-[300px] w-[219px] rounded-[8px] p-[1px] bg-white shadow-md'>
         <div className='flex justify-center p-1 items-center'>
            <Image src={product.photo} width={138} height={138} alt={product.name} />
         </div>
         <div className='flex flex-row w-[120px] min-h-[35px] p-1'>
            <div className='flex'>
               ...
               <div className={`${montPrice.className} justify-center items-center text-[15px] text-white w-[85px] max-w-[200px] h-[26px] text-center rounded-[5px] bg-[#373737]`}>
                  <p>R${product.price}</p>
               </div>
            </div>
         </div>
